...
(function (_) {
    _.translations["zh-CN"] = {
        ...
        sms: {
            ...
            dtu_serial_device:" Введите серийный порт",
            dtu_baud_rate:" Введите скорость передачи в бодах",
            dtu_baud_rate_invalid:" Вводимая скорость не зависит от ожидаемого диапазона"
        },
        monitor: {
            must_be_number:" 请输入整数",
            overall_interval:"请输入通知间隔",
        ...
        SSS: {
            ...
            'SSS_CLS_OFFLINE' : 'Предупреждение',
            'SSS_CLS_ONLINE' : 'Нормально'
        },
        end: "" // 结束符号，没有意义
    }
})(I18n);